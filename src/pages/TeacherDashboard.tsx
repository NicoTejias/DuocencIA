    ...
    return (
        <div>
            ...
            {courses.length === 0 && !showCreate ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {courses.map((c: any) => (
                        <div key={c._id} onClick={() => setSelectedCourse(c)} className="bg-surface-light border border-white/5 rounded-2xl p-6 hover:border-accent/30 transition-all group cursor-pointer">
