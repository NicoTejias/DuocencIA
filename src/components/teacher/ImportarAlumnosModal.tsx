...
import { Upload, CheckCircle, X, Loader2, Cloud, FileSpreadsheet } from 'lucide-react'
...
export default function ImportarAlumnosModal({ course, onClose }: ImportarAlumnosModalProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            toast.success(`✅ ${result.added} alumnos añadidos y ${result.updated} actualizados exitosamente.`)
            onClose()
        } catch (err: any) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
            <div className="bg-surface border border-white/10 rounded-[2rem] max-w-xl w-full p-8 animate-in zoom-in-95 duration-300 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">Archivos XLSX o CSV</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center justify-between">
                         <div className="flex items-center gap-3">
                            <div className="relative inline-flex items-center cursor-pointer">
                                ...
                                />
                                <div className="w-10 h-5 bg-white/10 rounded-full peer peer-checked:bg-green-500 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all"></div>
                                <label htmlFor="clearToggle" className="ml-3 text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] cursor-pointer">Limpiar lista anterior</label>
                            </div>
                        </div>
                    </div>
